    ...
    return (
        ...
        <div className={classes.Footer}>
            <div className={classes.Left}>
                <ul>
                    <li id="Facebook">
                        <a href="/"><svg xmlns="true" width="20" height="20" fill="grey" viewBox="0 0 15 32.3">
                            <path d="M15,10.5H9.9V7.1c0-1.3,0.8-1.6,1.4-1.6h3.6V0l-5,0C4.4,0,3.2,4.1,3.2,6.8v3.7H0v5.7h3.2v16.1h6.7V16.2h4.5L15,10.5z" />
                        </svg></a>

                    </li>
                    <li id="Twitter">
                        <a href="/"> <svg xmlns="true" width="20" height="20" fill="grey" viewBox="0 0 33.6 23.4">
                    ...
                    <li id="Contact">
                        <a href="/"> <svg width="20" height="20" fill="grey" xmlns="true" 
            ...
            <div className={classes.Right}><ul id="Top">
                <li id="Top">
                    <svg xmlns="true" width="20" height="20" fill="grey" viewBox="0 0 22.1 40.8">
